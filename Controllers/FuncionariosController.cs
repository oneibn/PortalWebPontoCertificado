...
using PortalWebPontoCertificado.Data;
using PortalWebPontoCertificado.Models;

namespace PortalWebPontoCertificado.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CPF,Genero,PIS,Salario,Email,DataAdmissao")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CPF,Genero,PIS,Salario,Email,DataAdmissao")] Funcionarios funcionarios)
        {
